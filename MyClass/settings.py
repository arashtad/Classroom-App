...
SECRET_KEY = 'django-insecure-)2yep+i6(&zws)q@rwcs(rb5qo%27!#5*sj-rj)v(#w!d!7#cu'
...
#STATIC_ROOT = BASE_DIR / 'static_folder'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static_folder')]
VENV_PATH = os.path.dirname(BASE_DIR)
STATIC_ROOT = os.path.join(VENV_PATH, 'static_folder')
